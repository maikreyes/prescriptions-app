...
import { Button, Card, CardContent, Input, Select, StatusBadge, Pagination, PageLoading, EmptyState, ErrorState } from '@/components/ui';
...
export default function DoctorPrescriptionsPage() {
  ...
  const handleFilterChange = (key: keyof QueryParams, value: string | boolean) => {
                      ...
                      <tr key={prescription.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => window.location.href = `/doctor/prescriptions/${prescription.id}`}
                          >
